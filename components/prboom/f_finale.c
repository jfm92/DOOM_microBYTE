...
static void F_BunnyScroll (void)
{
  ...
  {
    // CPhipps - patch drawing updated
    V_DrawNamePatch((240-13*8)/2, (200-8*8)/2,0, "END0", CR_DEFAULT, VPT_STRETCH);
    laststage = 0;
    return;
  }
  ...
  // CPhipps - patch drawing updated
  V_DrawNamePatch((240-13*8)/2, (200-8*8)/2, 0, name, CR_DEFAULT, VPT_STRETCH);
}
